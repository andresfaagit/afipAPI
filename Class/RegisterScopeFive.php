...
class RegisterScopeFive extends AfipWebService {
	...
	var $soap_version 	= SOAP_1_1;		//SOAP_VERSION;
	var $WSDL 			= WSDL ;		//'ws_sr_padron_a5-production.wsdl';
	var $URL 			= URL ;			//'https://aws.afip.gov.ar/sr-padron/webservices/personaServiceA5';
	var $WSDL_TEST 		= WSDL_TEST;	//;'ws_sr_padron_a5.wsdl';
	var $URL_TEST 		= URL_TEST; 	//;'https://awshomo.afip.gov.ar/sr-padron/webservices/personaServiceA5';
